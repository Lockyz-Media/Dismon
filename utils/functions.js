module.exports = (client) => {
    ...
    client.loadCommand = (cmdName) => {
        try {
            ...
            client.categories.set(props.help.category, props.help.category)
            if(props.help.category === "fun")
            {
                client.categories.fun.set(props.help.name, props.help.name);
            }
            if(props.help.category === "info")
            {
                client.categories.info.set(props.help.name, props.help.name);
            }
            if(props.help.category === "settings")
            {
                client.categories.settings.set(props.help.name, props.help.name);
            }
            return;
        } catch (err) {
